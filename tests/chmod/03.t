...
FreeBSD)
	...
	;;
Linux)
#        expect 0 mkdir -p ${path4093} 0755
#        expect 0 create ${path4095} 0644
#        expect 0 chmod ${path4095} 0642
#        expect 0 unlink ${path4095}
        expect ENAMETOOLONG chmod ${path4096} 0642
#        expect 0 rmdir -p ${path4093} 0755
	;;
esac
